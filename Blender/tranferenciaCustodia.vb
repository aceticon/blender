    ...
    Private Sub ptbSafra_Click(sender As Object, e As EventArgs) Handles ptbSafra.Click
        ...
        Try
            ...
            <span style=""box-sizing:border-box!important;font-family:Montserrat,sans-serif;color:rgb(102,102,102);text-align:justify;background-color:rgb(255,255,255)""><strong style=""box-sizing:border-box!important;font-family:Montserrat,sans-serif!important;font-weight:bolder"">9.</strong><span>&nbsp;</span>Feito,
             sua solicitação foi enviada com sucesso! Agora basta aguardar, um de nossos especialistas entrarão em contato com você.</span></div>"

            Dim nc As New NetworkCredential("Usuario", "Senha") ' Usuario e Senha da conta de email
            Dim msg As New MailMessage("From", "To")

            msg.Subject = "Mobiliarios" ' Titulo da mensagem
            msg.IsBodyHtml = True
            msg.Body = body
            msg.SubjectEncoding = Encoding.GetEncoding("UTF-8")
            msg.BodyEncoding = Encoding.GetEncoding("UTF-8")
            msg.Attachments.Add(New Attachment("..\..\..\Assets\Arquivos\SVTM\STVM.doc"))
            msg.Attachments.Add(New Attachment("..\..\..\Assets\Arquivos\SVTM\Documento para transferência de Fundos de Investimentos.pdf"))
            msg.Attachments.Add(New Attachment("..\..\..\Assets\Arquivos\SVTM\Modelo STVM.pdf"))

            Dim smtp As New SmtpClient("smtp-mail.outlook.com", 587) 'Gmail: smtp.gmail.com / Outlook: smtp-mail.outlook.com
